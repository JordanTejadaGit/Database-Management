...
CREATE TABLE IF NOT EXISTS `homeinventorydb`.`users` (
  ...
  `EmailConfirmationUUID` VARCHAR(50) NULL,
...
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('admin','password','jordantejada.school+admin@gmail.com','Admin','Admin',1,1, null, null);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('admin2','password','jordantejada.school+admin2@gmail.com','Admin2','Admin2',0,1, null, null);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('anne','password','jordantejada.school+anne@gmail.com','Anne','Annerson',1,0, null, null);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('barb','password','jordantejada.school+barb@gmail.com','Barb','Barber',1,0, null, null);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('carl','password','jordantejada.school+carl@gmail.com','Carl','Carlson',1,0, null, null);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`, `EmailConfirmationUUID`, `ResetPasswordUUID`) VALUES ('don','password','jordantejada.school+don@gmail.com','Don','Donatello',1,0, null, null);
